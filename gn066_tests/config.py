...
rainfall_file = Path("C:/Users/c1948616/Downloads/Shared Folder/Dry day and heavy rainfall discharges (Test1&2)/Examples/Castle Meadows/Inputs/SOAF_NRW_Rainfall 2012-2023.csv")
...
runs =[]
spills_baseline = (Path(r""), "None", "OC Fixed Baseline")
